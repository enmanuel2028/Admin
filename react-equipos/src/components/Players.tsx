              ...
              <div className="mt-auto p-4 pt-0">
                <div className="action-buttons">
                  ...
                  <button 
                    ...
                    onClick={() => showConfirmDelete(jugador.idJugador)}
                  >
          ...
          <div className="modal-content">
            ...
            <div className="player-details-header">
              ...
              <div className="player-details-info">
                ...
                <p className="player-details-team">
                  {jugadorDetails.equipo_actual || 'Equipo no especificado'}
                </p>
            ...
            <div className="player-details-stats">
              <div className="player-details-stat">
                <div className="player-details-stat-value">{jugadorDetails.edad || 'N/A'}</div>
                <div className="player-details-stat-label">EDAD</div>
              </div>
              <div className="player-details-stat">
                <div className="player-details-stat-value">{jugadorDetails.altura ? `${jugadorDetails.altura}m` : 'N/A'}</div>
                <div className="player-details-stat-label">ALTURA</div>
              </div>
              <div className="player-details-stat">
                <div className="player-details-stat-value">{jugadorDetails.peso ? `${jugadorDetails.peso}kg` : 'N/A'}</div>
                <div className="player-details-stat-label">PESO</div>
              </div>
              <div className="player-details-stat">
                <div className="player-details-stat-value">{formatCurrency(jugadorDetails.valor_mercado)}</div>
                <div className="player-details-stat-label">VALOR</div>
              </div>
            </div>
            ...
            <div className="player-details-section">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <p><strong>Nacionalidad:</strong> {jugadorDetails.nacionalidad || 'N/A'}</p>
                  <p><strong>Pierna Hábil:</strong> {jugadorDetails.pierna_habil || 'N/A'}</p>
                  <p><strong>Posición Ideal:</strong> {jugadorDetails.posicion_ideal || 'N/A'}</p>
                </div>
                <div>
                  <p><strong>Fecha Nacimiento:</strong> {jugadorDetails.fecha_nacimiento || 'N/A'}</p>
                  <p><strong>Número:</strong> {jugadorDetails.numero_camiseta || 'N/A'}</p>
                </div>
              </div>
            </div>
